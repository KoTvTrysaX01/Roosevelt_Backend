...
INSERT INTO objetos (id, mapbox_json, nombre_objeto, descripcion, imagen, peligrosidad, id_zona, id_tipo_objeto) VALUES (1, '[-0.481472302211273, 38.34839297758327]', 'Escalera de Castillo', 'Escalera muy grande', './escalera_castillo.png', 1, 1, 3);
INSERT INTO objetos (id, mapbox_json, nombre_objeto, descripcion, imagen, peligrosidad, id_zona, id_tipo_objeto) VALUES (2, '[-0.4803870927337073, 38.34908023870918]', 'Escalera de Castillo 2', 'Escalera muy muy grande', './escalera_castillo.png', 1, 1, 3);
...
INSERT INTO usuarios (id, nombre, apellido, username, password, email,  email_sec, tel, fecha_nac, administrador) VALUES (1, 'vadim','elshin', 'admin',  '$2a$10$fzcGgF.8xODz7ptkmZC.OeX1Kj5GDI//FhW2sG0vlshW6ZAKJky0e', 'admin@balmis.com','admin1@balmis.com',  '100000000', '1990-01-01', TRUE); -- password: 5678
INSERT INTO usuarios (id, nombre, apellido, username, password, email,  email_sec, tel, fecha_nac, administrador) VALUES (2, 'john', 'doe', 'user',  '$2a$10$ayw3FCBIkupFt5n9lrmJQe9XZMJhZiNCjaoOkXo/Ba0KZgymO01ce', 'user@balmis.com','us@balmis.com',  '200000000', '1991-01-01',  FALSE); -- password: 1234
INSERT INTO usuarios (id, nombre, apellido, username, password, email,  email_sec, tel, fecha_nac, administrador) VALUES (3, 'Jose', 'Lopez', 'user1',  '$2a$10$ayw3FCBIkupFt5n9lrmJQe9XZMJhZiNCjaoOkXo/Ba0KZgymO01ce', 'user1@balmis.com','us1@balmis.com',  '200000000', '1991-01-01',  FALSE); -- password: 1234
INSERT INTO usuarios (id, nombre, apellido, username, password, email,  email_sec, tel, fecha_nac, administrador) VALUES (4, 'algo', 'otro', 'user2',  '$2a$10$ayw3FCBIkupFt5n9lrmJQe9XZMJhZiNCjaoOkXo/Ba0KZgymO01ce', 'user2@balmis.com','us2@balmis.com',  '200000000', '1991-01-01',  FALSE); -- password: 1234

ALTER TABLE usuarios ALTER COLUMN id RESTART WITH (SELECT COALESCE(MAX(id), 0) + 1 FROM usuarios);


INSERT INTO rutas (id, mapbox_json, nombre_ruta, descripcion, fecha_pub, likes_count, published, id_zona, id_usuario_autor) VALUES (1, 'coords...', 'Sun', '123', '1990-01-01', 30, false, 1, 1);
